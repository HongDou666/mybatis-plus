...
CREATE DATABASE IF NOT EXISTS `mybatis_plus` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mybatis_plus`;

-- 导出  表 mybatis_plus.address 结构
...
-- 正在导出表  mybatis_plus.address 的数据：~11 rows (大约)
...
-- 正在导出表  mybatis_plus.user 的数据：~4 rows (大约)
